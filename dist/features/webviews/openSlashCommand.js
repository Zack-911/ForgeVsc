...
exports.openSlashCommand = openSlashCommand;
const vscode = __importStar(require("vscode"));
function openSlashCommand() {
    const panel = vscode.window.createWebviewPanel("SlashCommandGenerator", "Slash Command Generator", vscode.ViewColumn.One, {
        enableScripts: true,
